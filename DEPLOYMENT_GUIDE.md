...
| Veo 3.0 (veo-3.0-generate-001) | GA |
| Veo 3.0 Fast (veo-3.0-fast-generate-001) | GA |
| Veo 2.0 (veo-2.0-generate-001) | GA |
| Gemini 2.0 Flash (gemini-2.0-flash-exp) | Public |
| Gemini 2.5 Flash Image (gemini-2.5-flash-image) | Public |
| Gemini 3 Pro Image (gemini-3-pro-image-preview) | Preview (需全局端點) |
