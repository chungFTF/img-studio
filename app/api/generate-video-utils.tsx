    ...
    options: [
      {
        ...
        label: 'Veo 3.1',
        indication: 'Latest model: Text-to-video & Image-to-video + Audio',
      },
      {
        value: 'veo-3.1-fast-generate-001',
        label: 'Veo 3.1 Fast',
        indication: 'Low latency model: Text-to-video + Audio',
      },
      {
      ...
      },
      {
        ...
        label: 'Veo 2',
        indication: 'Standard model: Text-to-video & Image-to-video',
      },
    ],
