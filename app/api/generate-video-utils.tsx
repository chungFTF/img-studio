    ...
    options: [
      {
        ...
        indication: 'Latest preview: Text-to-video & Image-to-video + Audio',
      },
      {
        value: 'veo-3.1-fast-generate-preview',
        label: 'Veo 3.1 Fast Preview',
        indication: 'Low latency preview: Text-to-video + Audio',
      },
      {
        value: 'veo-3.0-generate-001',
        label: 'Veo 3.0',
        indication: 'GA model: Text-to-video & Image-to-video + Audio',
      },
      {
        value: 'veo-3.0-fast-generate-001',
        label: 'Veo 3.0 Fast',
        indication: 'Low latency GA: Text-to-video + Audio',
      },
      {
        value: 'veo-2.0-generate-001',
        label: 'Veo 2.0',
        indication: 'Stable GA: Text-to-video & Image-to-video',
      },
    ],
